...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_vilt_parser.add_argument("--max-epochs", type=int, default=200)
    train_vilt_parser.add_argument("--patience", type=int, default=15)
    ...
    train_blip2_align_parser.add_argument("--max-epochs", type=int, default=200)
    train_blip2_align_parser.add_argument("--patience", type=int, default=15)
