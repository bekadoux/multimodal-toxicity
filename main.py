...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_clip_parser.add_argument("--max-epochs", type=int, default=10)
    train_clip_parser.add_argument("--patience", type=int, default=10)
    ...
    train_clip_align_parser.add_argument("--max-epochs", type=int, default=10)
    train_clip_align_parser.add_argument("--patience", type=int, default=10)
    ...
    train_vilt_parser.add_argument("--model-name", default="ViLTClassifier")
    train_vilt_parser.add_argument("--num-classes", type=int, default=2)
    train_vilt_parser.add_argument("--batch-size", type=int, default=64)
    train_vilt_parser.add_argument("--max-epochs", type=int, default=10)
    train_vilt_parser.add_argument("--patience", type=int, default=10)
    train_vilt_parser.add_argument("--min-delta", type=float, default=1e-4)
    train_vilt_parser.add_argument("--checkpoint-limit", type=int, default=3)
    train_vilt_parser.add_argument("--lr", type=float, default=1e-4)
    train_vilt_parser.add_argument(
        "--num-workers", type=int, default=DEFAULT_NUM_WORKERS
    )
    train_vilt_parser.add_argument("--prefetch-factor", type=int, default=2)
    train_vilt_parser.add_argument(
        "--pin-memory",
        action=argparse.BooleanOptionalAction,
        default=False,
    ...
    train_vilt_parser.add_argument(
        "--vilt-model-name",
        default=DEFAULT_VILT_MODEL_NAME,
        help="Hugging Face ViLT checkpoint name or local path.",
    )
    train_vilt_parser.add_argument(
        "--max-text-length",
        type=int,
    ...
    train_vilt_parser.add_argument(
        ...
        type=int,
        default=512,
        help="Hidden width of the downstream ViLT classifier head.",
    )
    train_vilt_parser.add_argument("--weight-decay", type=float, default=1e-4)
    train_vilt_parser.add_argument(
        "--checkpoint-strategy",
        choices=["best-per-metric", "best-loss"],
        default="best-per-metric",
    ...
    train_blip2_parser.add_argument("--max-epochs", type=int, default=10)
    train_blip2_parser.add_argument("--patience", type=int, default=10)
    ...
    train_blip2_align_parser = train_subparsers.add_parser(
        "blip2-align",
        help="Train BLIP-2 align-fusion classifier",
    )
    train_blip2_align_parser.add_argument(
        "data_root", nargs="?", default="./data/hateful_memes/"
    )
    train_blip2_align_parser.add_argument(
        "--model-name", default="BLIP2AlignFusionClassifier"
    )
    train_blip2_align_parser.add_argument("--num-classes", type=int, default=2)
    train_blip2_align_parser.add_argument("--batch-size", type=int, default=64)
    train_blip2_align_parser.add_argument("--max-epochs", type=int, default=10)
    train_blip2_align_parser.add_argument("--patience", type=int, default=10)
    train_blip2_align_parser.add_argument("--min-delta", type=float, default=1e-4)
    train_blip2_align_parser.add_argument("--checkpoint-limit", type=int, default=3)
    train_blip2_align_parser.add_argument("--lr", type=float, default=1e-4)
    train_blip2_align_parser.add_argument(
        "--num-workers", type=int, default=DEFAULT_NUM_WORKERS
    )
    train_blip2_align_parser.add_argument("--prefetch-factor", type=int, default=2)
    train_blip2_align_parser.add_argument(
        "--pin-memory",
        action=argparse.BooleanOptionalAction,
        default=False,
    ...
    train_blip2_align_parser.add_argument("--map-dim", type=int, default=1024)
    train_blip2_align_parser.add_argument("--pre-output-dim", type=int, default=1024)
    train_blip2_align_parser.add_argument(
        "--num-pre-output-layers", type=int, default=3
    )
    train_blip2_align_parser.add_argument("--map-dropout", type=float, default=0.1)
    train_blip2_align_parser.add_argument("--fusion-dropout", type=float, default=0.4)
    train_blip2_align_parser.add_argument(
        "--pre-output-dropout", type=float, default=0.2
    )
    train_blip2_align_parser.add_argument("--weight-decay", type=float, default=1e-4)
    train_blip2_align_parser.add_argument(
        "--gradient-clip-val",
        type=float,
        default=0.1,
    ...
    eval_vilt_parser.add_argument("checkpoint_path")
    eval_vilt_parser.add_argument("data_root", nargs="?", default="data/hateful_memes/")
    eval_vilt_parser.add_argument("--num-classes", type=int, default=2)
    add_shared_dataloader_args(eval_vilt_parser)
    add_eval_metadata_arg(eval_vilt_parser)
    add_eval_selection_args(eval_vilt_parser)
    ...
    eval_blip2_align_parser = eval_subparsers.add_parser(
        "blip2-align",
        help="Evaluate BLIP-2 align-fusion classifier",
    )
    eval_blip2_align_parser.add_argument("checkpoint_path")
    eval_blip2_align_parser.add_argument(
        "data_root", nargs="?", default="data/hateful_memes/"
    )
    eval_blip2_align_parser.add_argument("--num-classes", type=int, default=2)
    add_shared_dataloader_args(eval_blip2_align_parser)
    add_eval_metadata_arg(eval_blip2_align_parser)
    add_eval_selection_args(eval_blip2_align_parser)
    eval_blip2_align_parser.set_defaults(batch_size=64)
    eval_blip2_align_parser.add_argument(
        "--blip2-model-name",
        default="Salesforce/blip2-itm-vit-g",
    )
    eval_blip2_align_parser.add_argument("--map-dim", type=int, default=1024)
    eval_blip2_align_parser.add_argument("--pre-output-dim", type=int, default=1024)
    eval_blip2_align_parser.add_argument("--num-pre-output-layers", type=int, default=3)
    eval_blip2_align_parser.add_argument("--map-dropout", type=float, default=0.1)
    eval_blip2_align_parser.add_argument("--fusion-dropout", type=float, default=0.4)
    eval_blip2_align_parser.add_argument(
        "--pre-output-dropout", type=float, default=0.2
    )
...
def main() -> None:
    ...
    if args.command == "train" and args.model == "blip2-align":
        from commands.train_blip2_align import train_blip2_align
    ...
    if args.command == "eval" and args.model == "vilt":
        from commands.eval_vilt import validate_vilt
    ...
    if args.command == "eval" and args.model == "blip2-align":
        from commands.eval_blip2_align import validate_blip2_align
